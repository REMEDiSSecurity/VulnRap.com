...
const DATASET_FILES: Record<keyof DatasetPaths, string[]> = {
  curatedV2: [
    "vuln_reports_dataset_v2.json.gz",
    "vuln_reports_dataset_v2.json",
  ],
  hackerOneParquet: ["train-00000-of-00001.parquet"],
  nvdJsonl: ["nvd_cve_10000_records.jsonl", "nvd_cve_10000_records.jsonl.gz"],
  cisaKevJsonl: [
    "cisa_kev_1568_records.jsonl",
    "cisa_kev_1568_records.jsonl.gz",
  ],
};

export function discover(): DatasetPaths {
  const out: DatasetPaths = {
    curatedV2: null,
    hackerOneParquet: null,
    nvdJsonl: null,
    cisaKevJsonl: null,
  };
