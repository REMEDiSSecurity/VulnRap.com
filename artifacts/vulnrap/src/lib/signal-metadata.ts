...
export type SignalCategory = "hallucination" | "avri-gold" | "substance";
...
const HALLUCINATION: SignalMeta[] = [
  ...
  },
  {
    ...
    citations: [
      ...
      {
        label: "Apollo — Errors",
        href: "https://www.apollographql.com/docs/apollo-server/data/errors",
      },
    ],
    examples: [
      {
    ...
    examples: [
      {
        ...
        snippet:
          "Buffer at 0xdeadbeef, freed at 0xcafebabe, accessed at 0xfacefeed",
    ...
    examples: [
      {
        title: "Bare claim",
        snippet:
          "Compiling with -fsanitize=address shows AddressSanitizer detects the overflow.",
    ...
    examples: [
      {
        ...
        snippet:
          "The bug is in handle_packet_v2() which is called from net_worker_loop().",
    ...
    examples: [
      {
        title: "XSS → RCE jump",
        snippet:
          "The reflected XSS allows full remote code execution on the server.",
    ...
    examples: [
      {
        ...
        snippet:
          "Open requirements.txt, then run go mod tidy, then mvn install.",
...
const AVRI_GOLD: SignalMeta[] = [
    ...
    examples: [
      {
        ...
        snippet:
          "==12345==ERROR: AddressSanitizer: heap-buffer-overflow on address 0x602000001234 at pc 0x000000401234",
  ...
  },
  {
    ...
    family: "MEMORY_CORRUPTION",
    description:
      "Crash backtrace with hex offsets (e.g. #0 0x7ffff7a01234 in foo).",
    whyItMatters:
      "Frame addresses and symbol+offset pairs are the second-strongest evidence after a sanitizer SUMMARY line.",
    technicalDetail:
      "Matches #\\d+\\s+0x[0-9a-f]{6,} on ≥1 frame. Worth +12 in the Memory Corruption rubric.",
    citations: [ASAN_DOC],
    examples: [
      {
  ...
  },
  {
    ...
    family: "INJECTION",
    description:
      "Source code showing the unsafe SQL/command construction (string concat, format(), exec()).",
    whyItMatters:
    ...
    citations: [
      {
        ...
        href: "https://owasp.org/www-community/Injection_Theory",
      },
    ],
    examples: [
      {
  ...
  },
  {
    ...
    family: "INJECTION / WEB_CLIENT",
    description:
      "Names a concrete HTTP method, path and parameter where the bug surfaces.",
    whyItMatters:
  ...
  },
  {
    ...
    family: "WEB_CLIENT",
    description:
      "Shows where in the response or DOM the payload lands (innerHTML, attribute value, response body).",
    whyItMatters:
    ...
    examples: [
      {
        ...
        snippet:
          'Response body contains: <input value="<svg onload=alert(1)>">',
  ...
  },
  {
    ...
    citations: [
      ...
      {
        label: "GCP — Metadata server",
        href: "https://cloud.google.com/compute/docs/metadata/overview",
      },
    ],
    examples: [
      {
  ...
  },
  {
    ...
    family: "WEB_CLIENT",
    description:
      "Concrete traversal payload reaching a sensitive file (../../etc/passwd, ..%2f, %252e%252e/).",
    whyItMatters:
  ...
  },
  {
    ...
    family: "AUTHN_AUTHZ",
    description:
      "Demonstrates access between two distinct accounts/users (Alice, Bob, user_a, user_b).",
    whyItMatters:
    ...
    examples: [
      {
        ...
        snippet:
          "Logged in as alice@…, called GET /api/orders/42 → returned bob's order.",
  ...
  },
  {
    ...
    family: "AUTHN_AUTHZ",
    description:
      "Shows changing an object id in a URL to access another resource.",
    whyItMatters:
      "IDOR is the most common authorization bug. The report needs the request that crosses the boundary.",
    technicalDetail:
      "Matches /users/N, /orders/N, /invoices/N path segments or ?id=N query patterns.",
    citations: [
      {
        label: "OWASP — IDOR",
  ...
  },
  {
    ...
    citations: [
      {
        label: "NIST SP 800-131A — Algorithms & Key Lengths",
  ...
  },
  {
    ...
    family: "CRYPTO",
    description:
      "Provides a known-answer test or named cryptographic constants (IV, nonce, key).",
    whyItMatters:
      "A KAT lets the maintainer reproduce the cryptographic break deterministically. Without one, breaks are hard to verify.",
    technicalDetail:
      'Matches "test vector", "KAT", "known answer", or hex key/IV/nonce assignments.',
    citations: [
      {
        label: "NIST CAVP — KATs",
  ...
  },
  {
    ...
    technicalDetail:
      'Matches <!DOCTYPE … [ <!ENTITY … SYSTEM "file:|http:|gopher:|ftp:" …',
    citations: [
      {
        label: "OWASP — XXE",
  ...
  },
  {
    ...
    description:
      "ThreadSanitizer / Helgrind / DRD output evidencing a data race.",
    whyItMatters:
      "Race conditions are notoriously hard to reproduce. A TSan/Helgrind dump is the strongest non-manual evidence.",
    technicalDetail:
      "Matches ThreadSanitizer / TSAN: / Helgrind / ==N== possible data race / DRD: prefixes.",
    citations: [
      {
  ...
  },
  {
    ...
    family: "REQUEST_SMUGGLING",
    description:
      "Both Transfer-Encoding: chunked and Content-Length: present in the same request.",
    whyItMatters:
  ...
  },
  {
    ...
    family: "FLAT",
    description:
      "A unified-diff hunk (--- / +++ / @@ -N,N +N,N @@) is included.",
    whyItMatters:
  ...
  },
  {
    ...
    family: "FLAT",
    description:
      "A source file path with an explicit line reference (src/foo.c:142, lib/bar.py#L88).",
    whyItMatters:
