      ...
      <Card className="bg-card/40 backdrop-blur border-border">
        ...
        <CardContent className="space-y-4 text-sm text-muted-foreground leading-relaxed">
          ...
          <div className="space-y-3">
            ...
            <p>
              VulnRap's similarity engine uses deterministic, seeded algorithms (SHA-256 for hashing, MinHash with 128 permutations for fuzzy matching, Simhash for structural similarity, section-level SHA-256 for granular matching). Slop scoring uses a multi-axis fusion architecture: four independent axes (Linguistic AI Fingerprinting, Factual Verification, LLM Semantic Analysis, Template Detection) are combined via Bayesian weighting into a single slopScore. A separate qualityScore measures report completeness independently. When the LLM axis is enabled, the redacted version of your report is sent to the configured AI provider for analysis. If the LLM is unavailable, the remaining axes redistribute weights automatically. The full scoring logic, fusion weights, and LLM prompt are <a href="https://github.com/REMEDiSSecurity/VulnRap.Com" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">open source and auditable on GitHub</a>.
            </p>
          </div>
          <Separator />
          <div className="space-y-3">
