    ...
    <div className="max-w-4xl mx-auto space-y-10">
      ...
      <Card className="bg-card/40 backdrop-blur border-primary/20">
        ...
        <CardContent className="space-y-4 text-sm leading-relaxed text-muted-foreground">
          ...
          <p>
            The <a href="https://github.com/REMEDiSSecurity/VulnRap.Com" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">project is open source</a>. If it turns out we can not keep funding it forever, the code is there for anyone to run their own instance.
          </p>
        </CardContent>
      </Card>
      ...
      <Card className="bg-card/40 backdrop-blur">
        ...
        <CardContent className="space-y-4 text-sm leading-relaxed text-muted-foreground">
          <ul className="space-y-2 list-disc pl-5">
            ...
            <li>We will keep the <a href="https://github.com/REMEDiSSecurity/VulnRap.Com" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">project open source</a> so anyone can verify these claims or run their own instance.</li>
          </ul>
        </CardContent>
      </Card>
