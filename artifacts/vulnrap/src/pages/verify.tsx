    ...
    return (
      <div className="max-w-2xl mx-auto text-center py-16">
        ...
        <p className="text-muted-foreground mt-2">
          This report ID does not exist or has been removed.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8 py-4">
      <div className="text-center space-y-3">
        <div className="flex justify-center">
          <img
            src={logoSrc}
            alt="VulnRap"
            className="w-14 h-14 rounded-lg shadow-lg shadow-primary/20 border border-primary/20"
          />
        </div>
        ...
        <p className="text-sm text-muted-foreground">
          Independent verification of vulnerability report {data.reportCode}
        </p>
      </div>
      ...
      <Card className="border-primary/20 bg-card/40 backdrop-blur">
        ...
        <CardContent className="space-y-6">
          <div className="flex flex-col items-center py-4">
            <div
              className={`text-6xl font-bold font-mono tracking-tighter ${getSlopColor(data.slopScore)}`}
            >
              {data.slopScore}
            </div>
            ...
            <div className="w-full max-w-sm mt-6 space-y-1">
              ...
              <Progress
                value={data.slopScore}
                className="h-2"
                indicatorClassName={getSlopProgressColor(data.slopScore)}
              />
            </div>
          </div>
          ...
          {data.slopScore < 30 && data.similarityMatchCount === 0 && (
            <div className="flex items-center gap-3 bg-green-500/10 border border-green-500/20 rounded-lg p-4">
              ...
              <div>
                ...
                <div className="text-xs text-muted-foreground">
                  This report shows no AI-generation signals and no duplicates
                  in our database.
                </div>
              </div>
            </div>
      ...
      <p className="text-xs text-muted-foreground text-center">
        This verification was generated by VulnRap.{" "}
