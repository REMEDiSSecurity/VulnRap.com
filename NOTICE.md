...
- **MinHash** — Broder, A. Z. (1997). "On the Resemblance and Containment of Documents." _Compression and Complexity of Sequences._
- **SimHash** — Charikar, M. S. (2002). "Similarity Estimation Techniques from Rounding Algorithms." _STOC '02._
- **Locality-Sensitive Hashing (LSH)** — Indyk, P., & Motwani, R. (1998). "Approximate Nearest Neighbors: Towards Removing the Curse of Dimensionality." _STOC '98._
- **Noisy-OR probability combination** — Pearl, J. (1988). _Probabilistic Reasoning in Intelligent Systems._ Used for multi-axis score fusion.
