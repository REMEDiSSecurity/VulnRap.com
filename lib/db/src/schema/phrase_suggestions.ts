...
export const phraseSuggestionsTable = pgTable("phrase_suggestions", {
  ...
  index("idx_phrase_suggestions_status_created_at").on(table.status, table.createdAt),
  index("idx_phrase_suggestions_ip_hmac_created_at").on(table.ipHmac, table.createdAt),
]);
